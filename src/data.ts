...
export const networkMetadata: Record<NetworkName, NetworkMetadata> = {
  Vodacom: {
    ...
    textColor: '#FFFFFF',
    logoLetter: 'V',
    description: 'Vodacom offers prepaid mobile data, LTE and personalised channels; check local coverage and the current checkout terms.',
    ussdBalance: '*135#',
  ...
  MTN: {
    ...
    textColor: '#031636',
    logoLetter: 'M',
    description: 'MTN offers prepaid, social and night-data products; check local coverage and the current bundle terms.',
    ussdBalance: '*136#',
  ...
  Telkom: {
    ...
    textColor: '#FFFFFF',
    logoLetter: 'T',
    description: 'Telkom offers prepaid daily, weekly and social data products; compare like-for-like validity and coverage before buying.',
    ussdBalance: '*188#',
...
export const bundles: Bundle[] = [
  ...
  },
  {
    ...
    anytimeData: '1GB',
    costPerGb: 25,
    bestFor: 'Short-term 1GB general-use option',
    watchOut: 'Expires at midnight on the day of purchase',
    ...SOURCES.cellcDataBundles,
    sourceConfidence: 'verified',
    lastVerified: '2026-08-02',
...
export const ussdCodes = [
  ...
  { id: 'ussd.vodacom.transfer_airtime_data', network: 'Vodacom', purpose: 'Data Bundle Transfer / Buy', code: '*135*1002#', category: 'Data' },
...
export const networkStats: NetworkStats[] = [
  {
    ...
    avgSpeed5G: 'Location-dependent 4G/5G',
    resilience: 'No independent benchmark',
    pricePoint: 'Prepaid and LTE rows',
  },
  {
    network: 'MTN',
    coverage: 'Check official map locally',
    avgSpeed5G: 'Location-dependent 4G/5G',
    resilience: 'No independent benchmark',
    pricePoint: 'Prepaid, social and night rows',
  },
  {
    network: 'Telkom',
    coverage: 'Check official map locally',
    avgSpeed5G: 'Location-dependent 4G/5G',
    resilience: 'No independent benchmark',
    pricePoint: 'Daily, weekly and social rows',
  },
  {
    network: 'Cell C',
  ...
  {
    network: 'Rain',
    coverage: 'Check home 5G coverage',
    avgSpeed5G: 'Location and tier dependent',
    resilience: 'No independent benchmark',
    pricePoint: 'Unlimited home 5G rows',
  },
];
