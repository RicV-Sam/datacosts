...
function createAnytimeSeries(config: {
  ...
  return Object.entries(config.prices).map(([sizeValue, priceValue]) => {
    ...
    return {
      id: `${config.idPrefix}-${sizeGb}gb-2026-09`,
...
const fnbGuidePeriodNote =
  'The guide cover states 1 July 2026 to 30 June 2027, while page 32 retains older effective-period text ending 30 June 2026; the current price tables are used despite that internal date conflict.';
...
const fnbOffers = createAnytimeSeries({
  ...
  eligibility: 'Requires a qualifying FNB transactional account and an active FNB Connect SIM or eSIM; applicants must be 18+ or use an eligible linked youth account.',
  importantNotes: [fnbGuidePeriodNote],
  source: fnbSource
});
...
const standardBank10Gb: MonthlyDataDealOffer = {
  id: 'standard-bank-connect-10gb-bundle-2026-09',
...
const standardBank20Gb: MonthlyDataDealOffer = {
  id: 'standard-bank-connect-connected-gigs-plus-20gb-2026-09',
  providerId: 'standard-bank-connect',
  providerName: 'Standard Bank Connect',
  ...
  eligibility: standardBankEligibility,
  importantNotes: [
    'The public Standard Bank Connect SIM-plans page lists 20GB as the plan allocation at R209 per month.',
    'Subscription data expires on the last day before the debit-order date.',
    'The subscription is billed monthly in advance; recheck the live plan page before ordering.'
  ],
  rankingStatus: 'eligible',
  source: standardBankSimPlansSource
};
...
const standardBank35Gb: MonthlyDataDealOffer = {
  id: 'standard-bank-connect-connected-gigs-pro-35gb-2026-09',
  providerId: 'standard-bank-connect',
  providerName: 'Standard Bank Connect',
...
const capitec10Gb: MonthlyDataDealOffer = {
  id: 'capitec-connect-10gb-30-day-2026-09',
  ...
  eligibility: 'Requires age 18+, an active Capitec bank account and an active Capitec Connect SIM.',
...
const capitec20GbLongValidity: MonthlyDataDealOffer = {
  id: 'capitec-connect-20gb-60-day-2026-09',
  providerId: 'capitec-connect',
  providerName: 'Capitec Connect',
...
const vodacom10GbAdvertised: MonthlyDataDealOffer = {
  id: 'vodacom-prepaid-lte-5-plus-5-2026-09',
  providerId: 'vodacom',
...
const vodacom20GbAdvertised: MonthlyDataDealOffer = {
  ...
  id: 'vodacom-prepaid-lte-10-plus-10-2026-09',
...
const vodacom40GbAdvertised: MonthlyDataDealOffer = {
  ...vodacom10GbAdvertised,
  id: 'vodacom-prepaid-lte-20-plus-20-2026-09',
...
const mtnStreaming20Gb: MonthlyDataDealOffer = {
  id: 'mtn-entertainment-streaming-20gb-2026-09',
  providerId: 'mtn',
  providerName: 'MTN',
...
const mtnSuperData30Gb: MonthlyDataDealOffer = {
  id: 'mtn-super-data-30gb-2026-09',
  providerId: 'mtn',
  providerName: 'MTN',
...
const telkomDailyDose30Gb: MonthlyDataDealOffer = {
  id: 'telkom-daily-dose-30gb-2026-09',
  providerId: 'telkom',
  providerName: 'Telkom',
...
const cellCDayByDay30Gb: MonthlyDataDealOffer = {
  id: 'cell-c-day-by-day-30gb-2026-09',
  providerId: 'cell-c',
  providerName: 'Cell C',
...
const mtnHomeWifi30GbAdvertised: MonthlyDataDealOffer = {
  id: 'mtn-home-wifi-15-plus-15-2026-09',
  providerId: 'mtn',
  providerName: 'MTN',
...
export const september2026DealSnapshot: MonthlyDataDealSnapshot = {
  month: '2026-09',
