      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div>
                <h4 className="font-black text-slate-900 group-hover:text-[#1b6d24] transition-colors">Data Comparison Tool</h4>
            ...
            <button
              onClick={() => onNavigateToGuide('ussd')}
              className="flex items-center justify-between p-6 bg-white border border-slate-100 rounded-3xl hover:border-[#1b6d24] transition-all group text-left"
            >
              <div>
                <h4 className="font-black text-slate-900 group-hover:text-[#1b6d24] transition-colors">USSD Codes Directory</h4>
            ...
            {allGuides.filter(g => g.slug !== guide.slug).slice(0, 2).map(otherGuide => (
              <button
                key={otherGuide.slug}
                onClick={() => onNavigateToGuide(otherGuide.slug)}
                className="flex items-center justify-between p-6 bg-white border border-slate-100 rounded-3xl hover:border-[#1b6d24] transition-all group text-left"
              >
                <div>
                  <h4 className="font-black text-slate-900 group-hover:text-[#1b6d24] transition-colors line-clamp-1">{otherGuide.title.split(' - ')[0]}</h4>
        ...
        <section className="bg-[#031636] rounded-[2.5rem] p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <button
            onClick={onBack}
            className="px-8 py-4 bg-[#a0f399] text-[#031636] rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-transform relative z-10"
          >
            Compare All Prices
          </button>
