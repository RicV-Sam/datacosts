    ...
    <footer className="bg-white border-t border-slate-100 py-12 pb-32 md:pb-12">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
        ...
        <div className="flex flex-col gap-4">
          <a href="/fix/" onClick={(e) => { e.preventDefault(); onNavigateTo('fix-problem'); }} className="font-bold text-sm uppercase tracking-wider hover:text-[#1b6d24] transition-colors">
            Fix a Problem
          </a>
        ...
        <div className="flex flex-col gap-4">
          ...
          <a href="/africa-expansion/" className="text-left text-xs text-slate-500 hover:text-slate-900 transition-colors block">Our Africa Expansion</a>
