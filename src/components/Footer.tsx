        ...
        <div className="flex flex-col gap-4">
          ...
          {guides.map(guide => (
            <button
              ...
              className="text-left text-[10px] text-slate-500 hover:text-slate-900 transition-colors line-clamp-1"
            >
              {guide.title.split(' - ')[0]}
            </button>
          ))}
          <button onClick={() => onNavigateTo('ussd')} className="text-left text-[10px] text-slate-500 hover:text-slate-900 transition-colors">USSD Codes Directory</button>
        </div>
        <div className="flex flex-col gap-4">
