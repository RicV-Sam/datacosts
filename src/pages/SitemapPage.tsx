...
const sitemapGroups: SitemapGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/best-data-deals-south-africa/', label: 'Monthly Data Deal Tracker South Africa' },
      { href: '/best-10gb-data-deals-south-africa/', label: 'Best 10GB Data Deals South Africa' },
      { href: '/best-20gb-data-deals-south-africa/', label: 'Best 20GB Data Deals South Africa' },
      { href: '/best-30gb-data-deals-south-africa/', label: 'Best 30GB Data Deals South Africa' },
