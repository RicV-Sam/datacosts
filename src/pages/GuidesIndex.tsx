  ...
  const hubSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { slug: 'stop-wasp-subscriptions-south-africa', title: 'Stop WASP Subscriptions in South Africa', description: 'Stop premium-service airtime deductions.', path: '/guides/stop-wasp-subscriptions-south-africa/' },
        ...
        { slug: 'stop-background-data-usage-android', title: 'Stop Android Background Data Usage', description: 'Find the apps using data in the background and restrict only the biggest drains.', path: '/data-problems/how-to-stop-background-data-usage-android/' },
        { slug: 'telkom-data-runs-out-fast', title: 'Why Telkom Data Runs Out So Fast', description: 'Compare Telkom bundle usage with phone activity and stop the largest drain first.', path: '/data-problems/why-does-my-data-run-out-so-fast-telkom/' },
        { slug: 'stop-telkom-airtime-disappearing', title: 'Stop Telkom Airtime Disappearing', description: 'Check fallback data, subscriptions, and carrier billing before the next recharge.', path: '/data-problems/how-to-stop-airtime-disappearing-telkom/' },
        { slug: 'airtime-data-saving-tips-south-africa' },
