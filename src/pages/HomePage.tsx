...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const priorityPages = [
    ...
    { href: '/guides/airtime-data-saving-tips-south-africa/', label: 'Airtime & Data Saving Tips', onClick: () => onNavigate('guide', 'airtime-data-saving-tips-south-africa') },
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <a href="/guides/airtime-data-saving-tips-south-africa/" onClick={(e) => { e.preventDefault(); onNavigate('guide', 'airtime-data-saving-tips-south-africa'); }} className="bg-white border border-slate-100 rounded-2xl px-4 py-3 font-bold text-slate-700 hover:border-[#1b6d24] hover:text-[#1b6d24] transition-colors">Airtime and data saving tips</a>
